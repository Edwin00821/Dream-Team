...
var Practice = defineDocumentType(() => ({
  name: "Practice",
  filePathPattern: `practices/**/*.mdx`,
  contentType: "mdx",
  fields: {
    title: {
      type: "string",
...
var contentlayer_config_default = makeSource({
  ...
  documentTypes: [Practice, Author, Page],
  mdx: {
...
//# sourceMappingURL=compiled-contentlayer-config-MJN4TB7Q.mjs.map
